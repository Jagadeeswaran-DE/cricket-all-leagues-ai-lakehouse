...
def main() -> None:
    ...
    if not paths:
        append_audit_row(spark, args.catalog, args.schema, args.run_id, "ingest_register_files", "SUCCEEDED", run_mode=args.run_mode, started_at=task_started_at)
        return
    ...
    append_audit_row(spark, args.catalog, args.schema, args.run_id, "ingest_register_files", "SUCCEEDED", len(paths), 1 if people_path else 0, 1 if people_path else 0, run_mode=args.run_mode, started_at=task_started_at)
